...
const config = {
  title: 'ZeroSettleKit',
  tagline: 'Seamless stablecoin settlements for mobile games and apps',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'API Reference',
                to: '/docs/api/classes/zerosettlemanager',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} ZeroSettle. Built with Docusaurus.`,
      },
      prism: {
